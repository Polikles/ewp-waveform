...
You need `prores_ks` and `png` encoders and the `gblur`, `overlay`, `scale`, `alphamerge`, and `lut` filters. `waveform doctor` checks these. Do not vendor FFmpeg into the repo.
